...
<script>
    layui.use(['element', 'form', 'layer','upload'], function () {
        ...
        upload.render({
            elem: "#briefImage",
            url: "${pageContext.request.contextPath}/house/updateBriefImage",
            field: 'brief',
        ...
        let demoListView = $('#detailsList')
            ...
            elem: '#MultipleUpload'
            , url: '${pageContext.request.contextPath}/house/updateDetailsImage'
            , accept: 'file'
            , multiple: true
            , field: "detailsImage"
            , auto: false
