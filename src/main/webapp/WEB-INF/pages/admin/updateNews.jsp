...
<div class="wrapper" style="width: 900px;margin-top: 40px">
    <fieldset class="layui-elem-field layui-field-title">
        <legend style="font-size: 26px">修改新闻</legend>
    </fieldset>
    <form id="updateNewsForm" class="layui-form">
        <div class="layui-form-item">
            <label class="layui-form-label">新闻标题</label>
            <div class="layui-input-block">
                <input type="hidden" name="newsId" value="${News.newsId}">
                <input type="text" name="title" placeholder="请输入标题" class="layui-input" required
                       lay-verify="required" autocomplete="off" value="${News.title}"></input>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea name="content" placeholder="请输入内容" class="layui-textarea" required
                          lay-verify="required" autocomplete="off">${News.content}</textarea>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit lay-filter="updateNewsRecord" id="updateNewsRecord-btn">现在发布</button>
...
<script>
    layui.use(['element', 'form', 'layer', 'upload'], function () {
        ...
        upload.render({
            elem: "#briefImage",
            url: "${pageContext.request.contextPath}/news/updateBriefImage",
            field: 'brief',
        ...
        let demoListView = $('#detailsList')
            ...
            elem: '#MultipleUpload'
            , url: '${pageContext.request.contextPath}/news/updateDetailsImage'
            , accept: 'file'
            , multiple: true
            , field: "detailsImage"
            , auto: false
        ...
        form.on("submit(updateNewsRecord)", function (data) {
            $.post("${pageContext.request.contextPath}/news/updateNewsRecord", $("#updateNewsForm").serialize(), function (res) {
                if (res === "OK") {
                    layer.msg("修改成功！", {
                        icon: 1, end: function () {
                            window.location.href = "/admin/allNews.html";
                        }
                    });
