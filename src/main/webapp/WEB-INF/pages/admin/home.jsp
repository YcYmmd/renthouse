...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-side">
        ...
        <ul class="layui-nav layui-nav-tree" lay-filter="test">
            <li class="layui-nav-item">
                <a href="javascript:void(0)">新闻信息管理</a>
                <dl class="layui-nav-child">
                    <dd><a href="${pageContext.request.contextPath}/admin/addNews.html" target="iframe">添加新闻</a></dd>
                    <dd><a href="${pageContext.request.contextPath}/admin/allNews.html" target="iframe">所有新闻信息</a></dd>
                </dl>
            </li>
        </ul>
    </div>
