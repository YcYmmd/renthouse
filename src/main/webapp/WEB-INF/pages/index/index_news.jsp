...
<div class="list_control_bar layui-container">
    <form action="/page1" method="post" class="form-inline" role="form" style="float:left;">
...
<section class="layui-container">
    <hr>
    <h2>共找到<span style="color: #ffc601;margin: 0 5px;">${requestScope.pageInfo.total}</span>条新闻，
    ...
    <div class="house-detail">
        <ul>
            <c:forEach items="${requestScope.pageInfo.list }" var="news">
                <li>
                    <a href="${pageContext.request.contextPath}/news/newsDetail?id=${news.newsId }" class="show-image">
                        <img src="${news.image }" width="240px" height="180px">
                    </a>
                    <div class="show-details">
                        <p class="house-title">
                            <a href="${pageContext.request.contextPath}/news/newsDetail?id=${news.newsId }">${news.title }</a>
                        </p>
                        <p class="house-about">${news.content}</p>
                    </div>
                </li>
            </c:forEach>
            <h2>
...
<script type="text/javascript">
    ...
    function pageSelectCallback(pageIndex,jQuery) {
        ...
        // 跳转到对应的页面
        window.location.href = "${pageContext.request.contextPath}/page1?pageNum=" + pageNum+"&keyword=${param.keyword}";
