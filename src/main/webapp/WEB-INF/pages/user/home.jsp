        ...
        <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
            <li class="layui-nav-item" lay-unselect="" style="">
                <a href="javascript:void(0)">
                    <img src="${loginUser.userAvatar}" style="width: 40px;height: 40px;vertical-align: middle;"/>
                    <cite style="margin-top: 30px;">${loginUser.userNickName}，欢迎回来</cite>
                ...
                <dl class="layui-nav-child layui-anim layui-anim-upbit">
                    ...
                    <hr>
                    <dd style="text-align: center;">
                        <a href="${pageContext.request.contextPath}/user/updateInfo.html" target="iframe">修改信息</a>
                    </dd>
                    <hr>
