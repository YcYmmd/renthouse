...
public class AdminViewController {
    ...
    @GetMapping("/addNews.html")
    public String toAddNewsPage() {
        return "/admin/addNews.jsp";
    }

    @GetMapping("/allNews.html")
    public String toAllNewsPage() {
        return "/admin/allNews.jsp";
    }

    @RequestMapping("/updateNews.html")
    public String toUpdateNewsPage(int newsId,HttpServletRequest request) {
        News news = newsService.findNewsDetailsById(newsId);
        request.getSession().setAttribute("News",news);
        return "/admin/updateNews.jsp";
    }
}
